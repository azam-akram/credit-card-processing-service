					...
					<form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
						...
						<div class="row">
							<div class="form-group col-md-12">
								...
								<div class="col-md-8">
									<input type="text" ng-model="ctrl.creditCardInput.name" id="cname" class="username form-control input-sm" placeholder="Enter customer name" required ng-minlength="3"/>
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="form-group col-md-12">
								...
								<div class="col-md-8">
									<input type="text" ng-model="ctrl.creditCardInput.accountLimit" id="accountLimit" class="form-control input-sm" placeholder="Enter account limit." required ng-pattern="ctrl.onlyNumbers"/>
								</div>
							</div>
						</div>
						<div class="row">
